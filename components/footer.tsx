...
export function Footer (){
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        <div className="lg:flex lg:items-center">
          <a href="javascript:void(0)">
            <Image src={micro} alt='' width={200} height={200}></Image>
          </a>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li>
              <Link href=''>Email : nileshsingh82004@gmail.com</Link>
            </li>
            <li>
            <Link href=''>Phone : 9319601021</Link>
            </li>
            <li>
      ...
      <p className='text-gray-300 text-sm mt-10'>© 2023<Link className='mx-1 font-semibold hover:text-accent' href='/'>Microbird</Link>All Rights Reserved.
      </p>
    </footer>
    </div>
  )
