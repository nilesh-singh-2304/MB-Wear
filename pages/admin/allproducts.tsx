...
<div className="p-4 sm:ml-64">
   ...
   <div className="mb-10 md:mb-10">
      <h2 className="mb-4 text-center text-2xl font-bold text-white md:mb-6 lg:text-3xl">All Products</h2>
    </div>
...
export async function getServerSideProps(context){
    ...
    return{
      props:{ prod: JSON.parse(JSON.stringify(products)) } // will be passed to page components as props
    } 
}        
